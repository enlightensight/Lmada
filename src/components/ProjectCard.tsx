...
export default function ProjectCard({ project }: ProjectCardProps) {
  return (
    <Link 
      ...
      data-cursor="project"
    >
      <div className="relative overflow-hidden rounded-2xl md:rounded-3xl border border-neutral-200 bg-neutral-100 aspect-[4/3] transition-all duration-500 shadow-sm hover:shadow-md">
        {/* Project Image */}
      ...
      <div className="mt-4 flex items-center justify-between px-1">
        <div>
          <h3 className="text-lg md:text-xl font-serif font-medium text-neutral-900 group-hover:text-brand-orange transition-colors">
            {project.title}
          </h3>
